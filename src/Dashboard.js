...
function Dashboard(props) {
  ...
  useEffect(() => {
    ...
    axios
      .get(`${process.env.REACT_APP_BACKEND_URL}/enrolls/`)
      .then(function (response) {
        setCourses(response.data);
      })
      .catch(function (response) {
        console.log(
          "error in fetch enrolls. read the Important note in README.md of the project :|"
        );
      });
    axios
      .get(`${process.env.REACT_APP_BACKEND_URL}/whoami/`)
      .then(function (response) {
